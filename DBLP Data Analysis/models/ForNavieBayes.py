...
X_train, X_test, y_train, y_test = train_test_split(X, lab, test_size=0.25,random_state=0) # 70% training and 30% test
from sklearn.naive_bayes import GaussianNB
...
print("Accuracy of FOR Navie Bayes:",metrics.accuracy_score(y_test, y_pred))
